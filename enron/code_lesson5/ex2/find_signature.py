...
### mini-project.
words_file = "../ex1/your_word_data.pkl" 
authors_file = "../ex1/your_email_authors.pkl"
def my_func(words_file, author_file):
    ...
    ### train on only 150 events to put ourselves in thiWs regime
